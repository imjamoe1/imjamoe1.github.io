(function() {
  ...
  var unic_id = Lampa.Storage.set('lampac_unic_id', '');
  if (!unic_id) {
...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  ...
  function startPlugin() {
    ...
    <div class="full-start__button selector view--vokino vokino--button">
        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="100%" height="100%" viewBox="0 -1600 26168 8190" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd; width: auto; position: relative; margin-right: -0.8em;">
