// == Movie Logos | Clean and Working + Kinopoisk Ratings ==
(function () {
    'use strict';
    ...
    function create() { 
        ...
        this.update = function(data) { // Called on focus change with new movie data
            ...
            delete kpRatingsCache[data.id]; // Clear KP cache
            delete kpRatingsPending[data.id]; // Clear KP pending
