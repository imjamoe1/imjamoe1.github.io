(function() {
  ...
  var Defined = {
    api: 'lampac',
    localhost: 'https://lampa.freepad.keenetic.link/',
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["https://lampa.ruzha.ru/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('https://lampa.ruzha.ru', function() {});
    }, true);
  }
  ...
  function rchRun(json, call) {
    if (typeof signalR == 'undefined') {
      Lampa.Utils.putScript(["https://lampa.ruzha.ru/signalr-6.0.25_es5.js"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('https://lampa.ruzha.ru/lite/withsearch'), function(json) {
  ...
  if (false) {
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
      ...
      $.get('https://lampa.ruzha.ru/player-inner/' + element.url);
      return;
    }
  ...
  function startPlugin() {
    ...
    var manifst = {
      ...
      version: '',
      name: 'Онлайн',
      description: 'Смотреть онлайн фильм и сериал',
      component: 'lampac',
