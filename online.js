...
<span style="vertical-align: middle; position: relative; bottom: 8px;">HDRezka</span>`,
    ...
    function addButton(e) {
      if (e.render.find('.hdrezka--button').length) return;
