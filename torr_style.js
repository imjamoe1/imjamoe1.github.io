(function () {
  ...
  var styles = {
    ...
    '.torrent-item__seeds > span.ts-seeds::before': {
      content: '"▲"',
      color: '#209932',
      'padding-right': '0',
    },
    ...
    '.torrent-item__seeds > span.ts-seeds': {
      ...
      'box-shadow': '0 0 0.75em rgba(252, 107, 3, 0.28)'
    },
    ...
    '.torrent-item__grabs > span.ts-grabs::before': {
      content: '"▼"',
      color: '#ed111c',
      'padding-right': '0'
    },
    ...
    '.torrent-item__size.ts-size': {
      ...
      //border: '0.15em solid rgba(152, 3, 252, 0.82)',
      'box-shadow': '0 0 0.7em rgba(152, 3, 252, 0.26)',
      'font-weight': '700'
    },
    ...
    '.torrent-item.selector.focus': {
      //'box-shadow': '0 0 0 0.3em rgba(26, 255, 0, 0.4)'
    },
