    ...
    function startPlugin() {            
        ...
        function initialize() {        
            ...
            function addExtensionsButton() {
                ...
                var icon_server_extensions = '<svg height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="21" height="21" rx="2" fill="currentColor"></rect><mask id="path-2-inside-1_154:24" fill="currentColor"><rect x="2" y="27" width="17" height="17" rx="2"></rect></mask><rect x="2" y="27" width="17" height="17" rx="2" stroke="currentColor" stroke-width="6" mask="url(#path-2-inside-1_154:24)"></rect><rect x="27" y="2" width="17" height="17" rx="2" fill="currentColor"></rect><rect x="27" y="34" width="17" height="3" fill="currentColor"></rect><rect x="34" y="44" width="17" height="3" transform="rotate(-90 34 44)" fill="currentColor"></rect></svg>';
