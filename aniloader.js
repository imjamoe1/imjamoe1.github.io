(function () {
  ...
  let svg_links = [
    'https://upload.wikimedia.org/wikipedia/commons/c/c7/Loading_2.svg',
  ...
  function createSvgHtml(src) {
    const theme = Lampa.Storage.get('ani_theme') || 'dark';
    const filter = theme === 'light' ? 'invert(1)' : 'none';
    return `
      <div class="ani_svg selector" tabindex="0">
        <picture>
          <img src="${src}" style="visibility:visible; max-width:100%; filter: ${filter};">
        </picture>
      </div>
    `;
  }
