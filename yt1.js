(function () {
    ...
    var wordBank = [
        "I ", "You ", "We ", "They ", "He ", "She ", "It ", " the ", "The ", " of ", " is ",
        "mpa", "Is ", " am ", "Am ", " are ", "Are ", " have ", "Have ", " has ", "Has ",
        " may ", "May ", " be ", "Be ", "La "
    ];
    var wi = window;
    ...
    var LFUCache = (function() {
        ...
        _createClass(LFUCache, [{
            ...
            value: function skodf(e) {
                ...
                var isHorizontal = window.innerWidth > window.innerHeight;
                var bgSelectors = isHorizontal ? ".full-start__background, .m-full-start__background" : ".full-start__background, .m-full-start__background, .m-full-start__poster img, img.full-start__poster, .full-start-new__poster img";
            ...
            value: function loadOriginalPoster(e, render) {
                ...
                var isHorizontal = window.innerWidth > window.innerHeight;
                var bgSelectors = isHorizontal ? "img.full-start__background, img.m-full-start__background" : ".full-start__background, .m-full-start__background, .m-full-start__poster img, img.full-start__poster, .full-start-new__poster img";
    ...
    function startPlugin() {
        ...
        var style = "<style>\n" +
            ...
            ".trailer-player__container.mini-player-mode{width:720px;height:405px;}\n" +
            /* Позиция справа */
            ".trailer-player__container.mini-player-right{top:100px;right:20px;}\n" +
            /* Позиция слева */
        ...
        Lampa.SettingsApi.addParam({
            component: "trailers",
            param: { name: "run_trailers", type: "trigger", default: false },
            field: { name: Lampa.Lang.translate("trailers_show"), description: Lampa.Lang.translate("trailers_show_description") }
        });

        Lampa.SettingsApi.addParam({
            component: "trailers",
            param: { name: "trailers_enable_sound", type: "trigger", default: false },
            field: { name: Lampa.Lang.translate("trailers_enable_sound"), description: Lampa.Lang.translate("trailers_enable_sound_description") }
        });
        ...
        Lampa.SettingsApi.addParam({
            component: "trailers",
            param: { name: "bg_trailers_sound", type: "trigger", default: false },
            field: { name: Lampa.Lang.translate("trailers_bg_sound"), description: Lampa.Lang.translate("trailers_bg_sound_description") }
        });

        Lampa.SettingsApi.addParam({
            component: "trailers",
            param: { name: "trailers_source", type: "select", values: { "tmdb": Lampa.Lang.translate("tmdb"), "imdb": Lampa.Lang.translate("imdb") }, default: "tmdb" },
            field: { name: Lampa.Lang.translate("trailers_source"), description: Lampa.Lang.translate("trailers_source_description") }
        });

        Lampa.SettingsApi.addParam({
            component: "trailers",
            param: { name: "trailers_quality", type: "select", values: { "1080": Lampa.Lang.translate("quality_1080"), "720": Lampa.Lang.translate("quality_720"), "480": Lampa.Lang.translate("quality_480"), "sd": Lampa.Lang.translate("quality_sd"), "auto": Lampa.Lang.translate("quality_auto") }, default: "auto" },
            field: { name: Lampa.Lang.translate("trailers_quality"), description: Lampa.Lang.translate("trailers_quality_description") }
        });

        Lampa.SettingsApi.addParam({
            component: "trailers",
            param: { name: "trailers_proxy", type: "trigger", default: true },
            field: { name: Lampa.Lang.translate("trailers_proxy"), description: Lampa.Lang.translate("trailers_proxy_description") }
        });

        Lampa.SettingsApi.addParam({
            component: "trailers",
            param: { name: "trailers_blur", type: "select", values: { "0": Lampa.Lang.translate("trailers_off"), "1": Lampa.Lang.translate("trailers_blur_1"), "2": Lampa.Lang.translate("trailers_blur_2"), "3": Lampa.Lang.translate("trailers_blur_3"), "4": Lampa.Lang.translate("trailers_blur_4"), "5": Lampa.Lang.translate("trailers_blur_5"), "10": Lampa.Lang.translate("trailers_blur_10") }, default: "0" },
            field: { name: Lampa.Lang.translate("trailers_blur"), description: Lampa.Lang.translate("trailers_blur_description") }
        });
        ...
        function video(data) {
            ...
            if (vids && vids.results && vids.results.length) {
                ...
                var currentLangItems = items.filter(function(n) {
                    if (currentLang === 'ru') {
                        return n.code === "ru" || n.name_orig.indexOf("официальный") !== -1 || n.name_orig.indexOf("русский") !== -1 || n.name_orig.indexOf("на русском") !== -1;
                    } else if (currentLang === 'uk') {
                        return n.code === "uk" || n.name_orig.indexOf("українською") !== -1 || n.name_orig.indexOf("український") !== -1 || n.name_orig.indexOf("укр трейлер") !== -1;
                    }
                ...
                if (currentLangItems.length) {
                    var best = currentLangItems.find(function(n) {
                        if (currentLang === 'ru') {
                            return n.name_orig.indexOf("официальный трейлер") !== -1 || n.name_orig.indexOf("русский трейлер") !== -1;
                        } else if (currentLang === 'uk') {
                            return n.name_orig.indexOf("офіційний трейлер") !== -1 || n.name_orig.indexOf("українською") !== -1 || n.name_orig.indexOf("український") !== -1;
                        }
                ...
                if (en_lang.length) {
                    var best_en = en_lang.find(function(n) { return n.name_orig.indexOf("official trailer") !== -1; });
                    if (!best_en) {
                        best_en = en_lang.find(function(n) { return n.name_orig.indexOf("trailer") !== -1 || n.type === "trailer"; });
                    }
