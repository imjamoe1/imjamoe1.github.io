...
(function () {
	...
	var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
	var version_modss = '3.1', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = true, leftVipD = '999', user_id = '', uid = '4941c869e985f11cc37f636', IP = '', logged = undefined;
    ...
    auth: function(kp) {
      ...
      return {
		...
		balansers: function() {
		  var balansers = {"videocdn":"VideoCDN","collaps":"Collaps","filmix":"Filmix","hdr":"MODS's [4K, HDR]  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinopub":"KinoPub 4K","alloha":"Alloha 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdrezka":"HDRezka 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","zetflix":"Zetflix  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","uakino":"UAKino 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","eneida":"Eneida(Ukr)  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kodik":"Kodik  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","anilibria":"Anilibria  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","hdvb":"HDVB  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinobase":"Kinobase  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","cdnmovies":"CDNmovies","rezka":"Voidboost","kinotochka":"KinoTochka  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","mango":"ManGo 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>","kinofit":"KinoFit 4K  <span style=\"font-weight: 700;color:rgb(236,151,31)\">VIP</span>"};
    ...
    this.filter = function (filter_items, choice) {
      ...
      filter.set('sort', filter_sources.map(function (e, i) {
        var tpl = {
          ...
          source: e,
          selected: e == balanser, 
          ghost: i >= (Lampa.Storage.get('pro_pub', false) ? 4 : 3) ? true : false
        };
        if(i >= (Lampa.Storage.get('pro_pub', false) ? 4 : 3)) {
	...
	function startPlugin() {
		...
		*/
		...
		onContextLauch: function onContextLauch(object) {
			Lampa.Activity.push({
						url: '',
						title: Lampa.Lang.translate('modss_title_online') + "MODS's" + version_modss,
						component: 'modss_online',
						search: object.title,
		...
		function add() {
			...
			Lampa.SettingsApi.addParam({
				...
				field: {
					...
					description: '❇️ <b>💻 Macintosh</b><br><br>⚠️ <span style="font-weight:700;color:#ffda00">Не вошли в аккаунт или не верный email</span><br><br><div class="ad-server" style="margin: 0em 0em;"><div class="ad-server__text">Для активации <b style="color: #ffd402;">Vip</b> статуса перейдите в телеграм бот</div><img src="https://lampa.stream/group.jpg" class="ad-server__qr"><div class="ad-server__label">@modssmy_bot</div></div>'
				}
			});
			Lampa.SettingsApi.addParam({
				component: 'settings_modss',
      ...
      Lampa.SettingsApi.addParam({
    	...
    	Lampa.SettingsApi.addParam({
		  ...
		  //Proxy mods
			...
			['VideoCDN', 'Collaps'].forEach(function (itm) {
				Lampa.SettingsApi.addParam({
					component: 'mods_proxy',
					param: {
