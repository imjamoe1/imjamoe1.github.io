(function () {
  ...
  function createBadgeImg(type, isCard, index) {
    ...
    // Create a div container instead of direct img to avoid onerror issues
    return '<div class="' + className + '" style="animation-delay: ' + delay + '">' +
           '<img src="' + iconPath + '" draggable="false" oncontextmenu="return false;" style="display:block;width:auto;height:100%;">' +
           '</div>';
  }
