...
Р”Р»СЏ РїРѕР»СѓС‡РµРЅРёСЏ РґР°РЅРЅС‹С… СЃ РєРёРЅРѕРїРѕРёСЃРє РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ https://kinopoiskapiunofficial.tech/ - РїРѕР»СѓС‡РёС‚Рµ API РєР»СЋС‡ 
Р”Р»СЏ РїРѕР»СѓС‡РµРЅРёСЏ РґР°РЅРЅС‹С… Metacritic, Tomatoes, РЅР°РіСЂР°Рґ РёСЃРїРѕР»СЊСѓР·РµС‚СЃСЏ https://www.omdbapi.com/ - РїРѕР»СѓС‡РёС‚Рµ API РєР»СЋС‡ 

РњРѕР¶РЅРѕ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ РѕРґРёРЅРѕС‡РЅС‹Р№ РєР»СЋС‡ РёР»Рё РјР°СЃСЃРёРІ РєР»СЋС‡РµР№, РїРѕСЃР»Рµ РїРѕР»СѓС‡РµРЅРёСЏ API РєР»СЋС‡РµР№ РїРµСЂРµРґР°Р№С‚Рµ РёС… РєР°Рє РјР°СЃСЃРёРІС‹ С‡РµСЂРµР·:
    window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.OMDB_API_KEYS
РР»Рё РїСЂРѕСЃС‚Рѕ РІРІРµРґРёС‚Рµ РЅРёР¶Рµ РІ РєРѕРґРµ РїР»Р°РіРёРЅР°:
    var OMDB_API_KEYS = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.OMDB_API_KEYS) || ['YOU_KEY']; // api РєР»СЋС‡Рё РјР°СЃСЃРёРІРѕРј
    var KP_API_KEYS   = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.KP_API_KEYS)   || ['YOU_KEY']; // api РєР»СЋС‡Рё РјР°СЃСЃРёРІРѕРј

Р”Р»СЏ РїРѕР»СѓС‡РµРЅРёСЏ РґР°РЅРЅС‹С… Рѕ РєР°С‡РµСЃС‚РІРµ РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ jacred РїР°СЂСЃРµСЂ, РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ РїР»Р°РіРёРЅ РЅР°СЃС‚СЂРѕРµРЅ РЅР° РїРѕР»СѓС‡РµРЅРёРµ Р°РґСЂРµСЃР° Рё РєР»СЋС‡Р° РІР°С€РµРіРѕ РІРІРµРґРµРЅРѕРіРѕ jacred,
РІС‹ РјРѕР¶РµС‚Рµ РёР·РјРµРЅРёС‚СЊ СЌС‚Рѕ РІ РїРµСЂРµРјРµРЅРЅС‹С…:
    var JACRED_PROTOCOL = 'https://'; // РџСЂРѕС‚РѕРєРѕР» JacRed
    var JACRED_URL = Lampa.Storage.get('jackett_url'); // РђРґСЂРµСЃ JacRed РґР»СЏ РїРѕР»СѓС‡РµРЅРёСЏ РёРЅС„РѕСЂРјР°С†РёРё Рѕ РєР°СЂС‚РѕС‡РєР°С… Р±РµР· РїСЂРѕС‚РѕРєРѕР»Р° (jacred.xyz)
    var JACRED_API_KEY = Lampa.Storage.get('jackett_key'); // api РєР»СЋС‡ JacRed
...
(function() {
    ...
    var tmdb_svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" width="150" height="150">  <defs>    <linearGradient id="grad" x1="0" y1="0" x2="1" y2="0">      <stop offset="0%" stop-color="#90cea1"/>      <stop offset="56%" stop-color="#3cbec9"/>      <stop offset="100%" stop-color="#00b3e5"/>    </linearGradient>    <style>      .text-style {            font-weight: bold;        fill: url(#grad);        text-anchor: start;        dominant-baseline: middle;        textLength: 150;        lengthAdjust: spacingAndGlyphs;        font-size: 70px;      }    </style>  </defs>  <!-- Р’РµСЂС…РЅРёР№ СЂСЏРґ TM -->  <text class="text-style" x="0" y="50" textLength="150" lengthAdjust="spacingAndGlyphs">TM</text>  <!-- РќРёР¶РЅРёР№ СЂСЏРґ DB -->  <text class="text-style" x="0" y="120" textLength="150" lengthAdjust="spacingAndGlyphs">DB</text></svg>';
    ...
    Lampa.Lang.add({
         maxsm_ratings: {
            ru: 'Р РµР№С‚РёРЅРі Рё РєР°С‡РµСЃС‚РІРѕ',
            en: 'Rating & Quality',
            uk: 'Р РµР№С‚РёРЅРі С– СЏРєС–СЃС‚СЊ',
            be: 'Р СЌР№С‚С‹РЅРі С– СЏРєР°СЃС†СЊ',
            pt: 'ClassificaГ§ГЈo e Qualidade',
            zh: 'иЇ„е€†дёЋз”»иґЁ',
            he: 'Ч“Ч™ЧЁЧ•Ч’ Ч•ЧђЧ™Ч›Ч•ЧЄ',
            cs: 'HodnocenГ­ a kvalita',
            bg: 'Р РµР№С‚РёРЅРі Рё РєР°С‡РµСЃС‚РІРѕ'
        },
        maxsm_ratings_cc: {
            ru: 'РћС‡РёСЃС‚РёС‚СЊ Р»РѕРєР°Р»СЊРЅС‹Р№ РєРµС€',
            en: 'Clear local cache',
            uk: 'РћС‡РёСЃС‚РёС‚Рё Р»РѕРєР°Р»СЊРЅРёР№ РєРµС€',
            be: 'РђС‡С‹СЃС†С–С†СЊ Р»Р°РєР°Р»СЊРЅС‹ РєСЌС€',
            pt: 'Limpar cache local',
            zh: 'жё…й™¤жњ¬ењ°зј“е­',
            he: 'Ч Ч§Ч” ЧћЧЧћЧ•Чџ ЧћЧ§Ч•ЧћЧ™',
            cs: 'Vymazat mГ­stnГ­ mezipamД›ЕҐ',
            bg: 'РР·С‡РёСЃС‚РІР°РЅРµ РЅР° Р»РѕРєР°Р»РЅРёСЏ РєРµС€'
        },
        maxsm_ratings_critic: {
            ru: 'РћС†РµРЅРєРё РєСЂРёС‚РёРєРѕРІ',
            en: 'Critic Ratings',
            uk: 'РћС†С–РЅРєРё РєСЂРёС‚РёРєС–РІ',
            be: 'РђС†СЌРЅРєС– РєСЂС‹С‚С‹РєР°Сћ',
            pt: 'AvaliaГ§Гµes da crГ­tica',
            zh: 'еЅ±иЇ„дєєиЇ„е€†',
            he: 'Ч“Ч™ЧЁЧ•Ч’Ч™ ЧћЧ‘Ч§ЧЁЧ™Чќ',
            cs: 'HodnocenГ­ kritikЕЇ',
            bg: 'РћС†РµРЅРєРё РЅР° РєСЂРёС‚РёС†РёС‚Рµ'
        },
        maxsm_ratings_mode: {
            ru: 'РЎСЂРµРґРЅРёР№ СЂРµР№С‚РёРЅРі',
            en: 'Average rating',
            uk: 'РЎРµСЂРµРґРЅС–Р№ СЂРµР№С‚РёРЅРі',
            be: 'РЎСЏСЂСЌРґРЅС– СЂСЌР№С‚С‹РЅРі',
            pt: 'ClassificaГ§ГЈo mГ©dia',
            zh: 'е№іеќ‡иЇ„е€†',
            he: 'Ч“Ч™ЧЁЧ•Ч’ ЧћЧћЧ•Ч¦Чў',
            cs: 'PrЕЇmД›rnГ© hodnocenГ­',
            bg: 'РЎСЂРµРґРµРЅ СЂРµР№С‚РёРЅРі'
        },
        maxsm_ratings_mode_normal: {
            ru: 'РџРѕРєР°Р·С‹РІР°С‚СЊ СЃСЂРµРґРЅРёР№ СЂРµР№С‚РёРЅРі',
            en: 'Show average rating',
            uk: 'РџРѕРєР°Р·СѓРІР°С‚Рё СЃРµСЂРµРґРЅС–Р№ СЂРµР№С‚РёРЅРі',
            be: 'РџР°РєР°Р·РІР°С†СЊ СЃСЏСЂСЌРґРЅС– СЂСЌР№С‚С‹РЅРі',
            pt: 'Mostrar classificaГ§ГЈo mГ©dia',
            zh: 'жѕз¤єе№іеќ‡иЇ„е€†',
            he: 'Ч”Ч¦Ч’ Ч“Ч™ЧЁЧ•Ч’ ЧћЧћЧ•Ч¦Чў',
            cs: 'Zobrazit prЕЇmД›rnГ© hodnocenГ­',
            bg: 'РџРѕРєР°Р·РІР°РЅРµ РЅР° СЃСЂРµРґРµРЅ СЂРµР№С‚РёРЅРі'
        },
        maxsm_ratings_mode_simple: {
            ru: 'РўРѕР»СЊРєРѕ СЃСЂРµРґРЅРёР№ СЂРµР№С‚РёРЅРі',
            en: 'Only average rating',
            uk: 'Р›РёС€Рµ СЃРµСЂРµРґРЅС–Р№ СЂРµР№С‚РёРЅРі',
            be: 'РўРѕР»СЊРєС– СЃСЏСЂСЌРґРЅС– СЂСЌР№С‚С‹РЅРі',
            pt: 'Apenas classificaГ§ГЈo mГ©dia',
            zh: 'д»…жѕз¤єе№іеќ‡иЇ„е€†',
            he: 'ЧЁЧ§ Ч“Ч™ЧЁЧ•Ч’ ЧћЧћЧ•Ч¦Чў',
            cs: 'Pouze prЕЇmД›rnГ© hodnocenГ­',
            bg: 'РЎР°РјРѕ СЃСЂРµРґРµРЅ СЂРµР№С‚РёРЅРі'
        },
        maxsm_ratings_mode_noavg: {
            ru: 'Р‘РµР· СЃСЂРµРґРЅРµРіРѕ СЂРµР№С‚РёРЅРіР°',
            en: 'No average',
            uk: 'Р‘РµР· СЃРµСЂРµРґРЅСЊРѕРіРѕ СЂРµР№С‚РёРЅРіСѓ',
            be: 'Р‘РµР· СЃСЏСЂСЌРґРЅСЏРіР° СЂСЌР№С‚С‹РЅРіСѓ',
            pt: 'Sem mГ©dia',
            zh: 'ж— е№іеќ‡еЂј',
            he: 'ЧњЧњЧђ ЧћЧћЧ•Ч¦Чў',
            cs: 'Bez prЕЇmД›ru',
            bg: 'Р‘РµР· СЃСЂРµРґРµРЅ СЂРµР№С‚РёРЅРі'
        }, 
        maxsm_ratings_icons: {
            ru: 'Р—РЅР°С‡РєРё',
            en: 'Icons',
        ...
        maxsm_ratings_quality: {
            ru: 'РљР°С‡РµСЃС‚РІРѕ РІРЅСѓС‚СЂРё РєР°СЂС‚РѕС‡РµРє',
            en: 'Quality inside cards',
            uk: 'РЇРєС–СЃС‚СЊ РІСЃРµСЂРµРґРёРЅС– РєР°СЂС‚РѕРє',
            be: 'РЇРєР°СЃС†СЊ СѓРЅСѓС‚СЂС‹ РєР°СЂС‚Р°Рє',
            pt: 'Qualidade dentro dos cartГµes',
            zh: 'еЌЎз‰‡е†…зљ„иґЁй‡Џ',
            he: 'ЧђЧ™Ч›Ч•ЧЄ Ч‘ЧЄЧ•Чљ Ч›ЧЁЧЧ™ЧЎЧ™Чќ',
            cs: 'Kvalita uvnitЕ™ karet',
            bg: 'РљР°С‡РµСЃС‚РІРѕ РІСЉС‚СЂРµ РІ РєР°СЂС‚РёС‚Рµ'
        },
        maxsm_ratings_quality_inlist: {
            ru: 'РљР°С‡РµСЃС‚РІРѕ РЅР° РєР°СЂС‚РѕС‡РєР°С…',
            en: 'Quality on cards',
            uk: 'РЇРєС–СЃС‚СЊ РЅР° РєР°СЂС‚РєР°С…',
            be: 'РЇРєР°СЃС†СЊ РЅР° РєР°СЂС‚РєР°С…',
            pt: 'Qualidade nos cartГµes',
            zh: 'еЌЎз‰‡дёЉзљ„иґЁй‡Џ',
            he: 'ЧђЧ™Ч›Ч•ЧЄ Ч‘Ч›ЧЁЧЧ™ЧЎЧ™Чќ',
            cs: 'Kvalita na kartГЎch',
            bg: 'РљР°С‡РµСЃС‚РІРѕ РїРѕ РєР°СЂС‚РёС‚Рµ'
        },
        maxsm_ratings_quality_tv: {
            ru: 'РљР°С‡РµСЃС‚РІРѕ РґР»СЏ СЃРµСЂРёР°Р»РѕРІ',
            en: 'Quality for series',
            uk: 'РЇРєС–СЃС‚СЊ РґР»СЏ СЃРµСЂС–Р°Р»С–РІ',
            be: 'РЇРєР°СЃС†СЊ РґР»СЏ СЃРµСЂС‹СЏР»Р°Сћ',
            pt: 'Qualidade para sГ©ries',
            zh: 'е‰§й›†зљ„иґЁй‡Џ',
            he: 'ЧђЧ™Ч›Ч•ЧЄ ЧњЧЎЧ“ЧЁЧ•ЧЄ',
            cs: 'Kvalita pro seriГЎly',
            bg: 'РљР°С‡РµСЃС‚РІРѕ Р·Р° СЃРµСЂРёР°Р»Рё'
        }
    });
    ...
    // Р“Р»РѕР±Р°Р»СЊРЅР°СЏ РїРµСЂРµРјРµРЅРЅР°СЏ С‚РµРєСѓС‰РµР№ РєР°СЂС‚РѕС‡РєРё (СЃРµР№С‡Р°СЃ РЅРµ РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ)
    var globalCurrentCard = null;

    // РџРµСЂРµРїРµРјРЅРЅС‹Рµ РЅР°СЃС‚СЂРѕР№РєРё 
    var C_LOGGING = false;  // РћР±С‰РёР№ Р»РѕРіРіРёРЅРі 
    var Q_LOGGING = false;  // Р›РѕРіРіРёРЅРі РєР°С‡РµСЃС‚РІР°
    var CACHE_TIME = 3 * 24 * 60 * 60 * 1000;  // Р’СЂРµРјСЏ, РєРѕС‚РѕСЂРѕРµ РєРµС€ СЃС‡РёС‚Р°РµС‚СЃСЏ РІР°Р»РёРґРЅС‹Рј
    var Q_CACHE_TIME = 24 * 60 * 60 * 1000;  // Р’СЂРµРјСЏ, РєРѕС‚РѕСЂРѕРµ РєРµС€ СЃС‡РёС‚Р°РµС‚СЃСЏ РІР°Р»РёРґРЅС‹Рј
    ...
    var OMDB_API_KEYS = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.OMDB_API_KEYS) || ['c4fe9fcf']; // api РєР»СЋС‡Рё РјР°СЃСЃРёРІРѕРј
    var KP_API_KEYS   = (window.RATINGS_PLUGIN_TOKENS && window.RATINGS_PLUGIN_TOKENS.KP_API_KEYS)   || ['cc0875d7-b351-46bb-b97f-56787d2ea25d']; // api РєР»СЋС‡Рё РјР°СЃСЃРёРІРѕРј
    ...
    var PROXY_LIST = [  // РљРѕСЂСЃ РїСЂРѕРєСЃРё РґР»СЏ Р·Р°РїСЂРѕСЃРѕРІ 
        'https://cors.bwa.workers.dev/',
        'https://api.allorigins.win/raw?url='
    ];
    
    // РЎР»РѕРІР°СЂСЊ РІРѕР·СЂР°СЃС‚РЅС‹С… СЂРµР№С‚РёРЅРіРѕРІ
    var AGE_RATINGS = {
        'G': '3+',
        'PG': '6+',
        'PG-13': '13+',
    ...
    // Р’РµСЃРѕРІС‹Рµ РєРѕСЌС„С„РёС†РёРµРЅС‚С‹ РґР»СЏ РёСЃС‚РѕС‡РЅРёРєРѕРІ СЂРµР№С‚РёРЅРіРѕРІ
    var WEIGHTS = {
        imdb: 0.35,
        tmdb: 0.15,
        kp: 0.20,
    ...
    // Р‘РµСЂРµРј СЃР»СѓС‡Р°Р№РЅС‹Р№ С‚РѕРєРµРЅ РёР· РјР°СЃСЃРёРІР°
    function getRandomToken(arr) {
      if (!arr || !arr.length) return '';
      return arr[Math.floor(Math.random() * arr.length)];
    }
    
    // РџРѕР»СѓС‡Р°РµРј РєРѕР»РёС‡РµСЃС‚РІРѕ РЅР°РіСЂР°Рґ
    ...
    // РџРѕР»СѓС‡РµРЅРёРµ РґР°РЅРЅС‹С… С‡РµСЂРµР· РїСЂРѕРєСЃРё
...
//-----------------------------------------------------get---kinopoisk-------------------------------------
    function getKPRatings(normalizedCard, apiKey, localCurrentCard, callback) {
        // Р•СЃР»Рё РµСЃС‚СЊ kinopoisk_id - СЃСЂР°Р·Сѓ РїРµСЂРµС…РѕРґРёРј Рє Р·Р°РїСЂРѕСЃСѓ СЂРµР№С‚РёРЅРіРѕРІ
        ...
        // РЎС‚Р°СЂР°СЏ Р»РѕРіРёРєР° РїРѕРёСЃРєР° РїРѕ РЅР°Р·РІР°РЅРёСЋ/РіРѕРґСѓ
        var queryTitle = (normalizedCard.original_title || normalizedCard.title || '').replace(/[:\-вЂ“вЂ”]/g, ' ').trim();
        var year = '';
        ...
        .then(function(data) {
            ...
            var targetYear;
            var film2;
            // РЎРЅР°С‡Р°Р»Р° РїС‹С‚Р°РµРјСЃСЏ РЅР°Р№С‚Рё С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ
            for (var j = 0; j < data.films.length; j++) {
                ...
                // Р”РІРѕР№РЅР°СЏ РїСЂРѕРІРµСЂРєР° РЅР° РІР°Р»РёРґРЅРѕСЃС‚СЊ С‡РёСЃРµР»
            ...
            // Р•СЃР»Рё С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ РЅРµ РЅР°Р№РґРµРЅРѕ, РёС‰РµРј +- РіРѕРґ
            if (!bestMatch) {
        ...
        // РћР±С‰Р°СЏ С„СѓРЅРєС†РёСЏ РїРѕР»СѓС‡РµРЅРёСЏ СЂРµР№С‚РёРЅРіРѕРІ РїРѕ ID
...
//-------------------------------------------------end---get---kinopoisk-----------------------------------
    ...
    // РЈР»СѓС‡С€РµРЅРЅР°СЏ С„СѓРЅРєС†РёСЏ СѓРґР°Р»РµРЅРёСЏ Р°РЅРёРјР°С†РёРё
    function removeLoadingAnimation(localCurrentCard, render) {
        ...
        // РС‰РµРј РєРѕРЅС‚РµР№РЅРµСЂС‹ СЃ Р°РЅРёРјР°С†РёРµР№ С‚РѕР»СЊРєРѕ РІРЅСѓС‚СЂРё render
...
// ------------------------------------------------------------JacRed------------------------------------------------------------------------------   
    function getBestReleaseFromJacred(normalizedCard, localCurrentCard, callback) {
        ...
        var stopWords = ['camrip', 'РєР°РјСЂРёРї', 'ts', 'telecine', 'telesync', 'telesynch', 'upscale', 'tc', 'С‚СЃ'];
        var stopWordsPatterns = null;
    
        // РЈРїСЂРѕС‰РµРЅРЅР°СЏ С„СѓРЅРєС†РёСЏ РїРµСЂРµРІРѕРґР° РєР°С‡РµСЃС‚РІР° (СЂР°Р±РѕС‚Р°РµС‚ СЃ С‡РёСЃР»Р°РјРё)
        function translateQuality(quality) {
            switch(quality) {
                case 2160: return '4K';
                case 1080: return 'FHD';
                case 720: return 'HD';
                case 'TS': return 'TS'; // РЎРїРµС†РёР°Р»СЊРЅС‹Р№ СЃР»СѓС‡Р°Р№
                default: 
                    // Р”Р»СЏ РІСЃРµС… РѕСЃС‚Р°Р»СЊРЅС‹С… С‡РёСЃР»РѕРІС‹С… Р·РЅР°С‡РµРЅРёР№
                    return quality >= 720 ? 'HD' : 'SD';
            }
        }
    
        function hasLetters(str) {
            return /[a-zР°-СЏС‘]/i.test(str || '');
        }
        ...
        // Р”РѕР±Р°РІР»СЏРµРј РѕР±Р° Р·Р°РіРѕР»РѕРІРєР° РµСЃР»Рё РѕРЅРё РµСЃС‚СЊ
        var hasTitle = false;
        ...
        new Lampa.Reguest().silent(apiUrl, function(response) {
            ...
            try {
                ...
                // Р›РћР“РР РћР’РђРќРР• РџРћР›РќРћР“Рћ РћРўР’Р•РўРђ
                /*
                if (Q_LOGGING) {
                ...
                */
                ...
                // РџР°СЂСЃРёРј РѕС‚РІРµС‚ Рё РёР·РІР»РµРєР°РµРј Results
                ...
                for (var i = 0; i < torrents.length; i++) {
                    ...
                    // Р›РћР“РР РћР’РђРќРР• Р”Р•РўРђР›Р•Р™ РўРћР Р Р•РќРўРђ
                    /*
                    if (Q_LOGGING) {
                    ...
                    */
                    ...
                    // РџСЂРѕРїСѓСЃРєР°РµРј С‚РѕСЂСЂРµРЅС‚С‹ Р±РµР· РёРЅС„РѕСЂРјР°С†РёРё Рѕ РєР°С‡РµСЃС‚РІРµ
                    if (typeof usedQuality !== 'number' || usedQuality === 0) {
                        continue;
                    }
    
                    // РџСЂРѕРІРµСЂСЏРµРј РІР°Р»РёРґРЅРѕСЃС‚СЊ РіРѕРґР°
                    var yearValid = false;
                    var parsedYear = 0;
                    ...
                    // РџСЂРѕРІРµСЂСЏРµРј СЃРѕРѕС‚РІРµС‚СЃС‚РІРёРµ РіРѕРґР° (С‚РµРєСѓС‰РёР№ РёР»Рё РїСЂРµРґС‹РґСѓС‰РёР№)
                    if (parsedYear !== searchYearNum && parsedYear !== prevYear) {
                        continue;
                    }
    
                    // РџСЂРѕРІРµСЂСЏРµРј РЅР° СЃС‚РѕРї-СЃР»РѕРІР°
                    if (isScreenCopy(titleForCheck)) {
                        findStopWords = true;
                        continue;
                    }
    
                    // РџСЂРѕРІРµСЂСЏРµРј РјР°РєСЃРёРјР°Р»СЊРЅРѕРµ РєР°С‡РµСЃС‚РІРѕ
                    ...
                    // РћР±РЅРѕРІР»СЏРµРј Р»СѓС‡С€РёР№ С‚РѕСЂСЂРµРЅС‚
...
/*
    function getBestReleaseFromJacred(normalizedCard, localCurrentCard, callback) {
        ...
        var MAX_QUALITY = 2160;
        var stopWords = ['camrip', 'РєР°РјСЂРёРї', 'ts', 'telecine', 'telesync', 'telesynch', 'upscale']; // Р РµР»РёР·С‹ СЃ РґР°РЅРЅС‹РјРё СЃР»РѕРІР°РјРё РёРіРЅРѕСЂРёСЂСѓСЋС‚СЃСЏ
        var findStopWords = false;
        var stopWordsPatterns = null;
            ...
            new Lampa.Reguest().silent(apiUrl, function(response) {
                ...
                try {
                    ...
                    for (var i = 0; i < torrents.length; i++) {
                        ...
                        // РћР±СЂР°Р±РѕС‚РєР° РєР°С‡РµСЃС‚РІР°: РµСЃР»Рё РѕСЂРёРіРёРЅР°Р»СЊРЅРѕРµ РєР°С‡РµСЃС‚РІРѕ 0 - РїСЂРѕРїСѓСЃРєР°РµРј
                        if (typeof t.quality !== 'number' || t.quality === 0) {
                            // Р’СЂРµРјРµРЅРЅРѕРµ РѕС‚РєР»СЋС‡РµРЅРёРµ РїР°СЂСЃРёРЅРіР° РєР°С‡РµСЃС‚РІР°
                            continue; // РџСЂРѕРїСѓСЃРєР°РµРј СЂРµР»РёР·С‹ Р±РµР· РєР°С‡РµСЃС‚РІР°
                        }
                        
                        // РћР±СЂР°Р±РѕС‚РєР° РіРѕРґР°: РµСЃР»Рё РѕСЂРёРіРёРЅР°Р»СЊРЅС‹Р№ РіРѕРґ РЅРµРІР°Р»РёРґРµРЅ - РїСЂРѕРїСѓСЃРєР°РµРј
                        var yearValid = false;
                        var parsedYear = 0;
                        ...
                        if (!yearValid) {
                            ...
                            continue; // РџСЂРѕРїСѓСЃРєР°РµРј СЂРµР»РёР·С‹ Р±РµР· РіРѕРґР°
                        }
                        
                        // РџСЂРѕРІРµСЂРєР° СЃРѕРѕС‚РІРµС‚СЃС‚РІРёСЏ РіРѕРґР° (РµСЃР»Рё РіРѕРґ РёР·РІРµСЃС‚РµРЅ)
                        if (yearValid) {
                            if (!isNaN(searchYearNum)) {
                                if (parsedYear === searchYearNum) {
                                    ...
                                    continue; // РџСЂРѕРїСѓСЃРєР°РµРј С‚РѕСЂСЂРµРЅС‚С‹ СЃ РЅРµСЃРѕРѕС‚РІРµС‚СЃС‚РІСѓСЋС‰РёРј РіРѕРґРѕРј
                                }
                            } else {
                        ...
                        // РџСЂРѕРІРµСЂРєР° РЅР° screen copy
        ...
        // РџРѕСЃР»РµРґРѕРІР°С‚РµР»СЊРЅС‹Рµ СЃС‚СЂР°С‚РµРіРёРё РїРѕРёСЃРєР°
        var searchStrategies = [];
        
        // РЎС‚СЂР°С‚РµРіРёСЏ 1: РџРѕ original_title (С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ)
        if (normalizedCard.original_title && (hasLetters(normalizedCard.original_title) || onlyDigits(normalizedCard.original_title))) {
        ...
        // РЎС‚СЂР°С‚РµРіРёСЏ 2: РџРѕ original_title (С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ) -1РіРѕРґ
        if (normalizedCard.original_title && (hasLetters(normalizedCard.original_title) || onlyDigits(normalizedCard.original_title))) {
        ...
        // РЎС‚СЂР°С‚РµРіРёСЏ 3: РџРѕ title (С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ)
        if (normalizedCard.title && (hasLetters(normalizedCard.title) || onlyDigits(normalizedCard.title))) {
        ...
        // РЎС‚СЂР°С‚РµРіРёСЏ 4: РџРѕ title (С‚РѕС‡РЅРѕРµ СЃРѕРІРїР°РґРµРЅРёРµ) -1РіРѕРґ
        if (normalizedCard.title && (hasLetters(normalizedCard.title) || onlyDigits(normalizedCard.title))) {
        ...
        // Р РµРєСѓСЂСЃРёРІРЅР°СЏ РїСЂРѕРІРµСЂРєР° СЃС‚СЂР°С‚РµРіРёР№
        function tryNextStrategy(index) {
            ...
            searchJacred(strategy.title, strategy.year, strategy.exact, strategy.name, function(result) {
                if (result !== null) {
                    // Р”РћР‘РђР’Р›Р•Рќ Р›РћР“ РЎ РќРђР—Р’РђРќРР•Рњ Р РђР—Р”РђР§Р
        ...
        // Р—Р°РїСѓСЃРє РїРµСЂРІРѕР№ СЃС‚СЂР°С‚РµРіРёРё
    ...
    */
// ------------------------------------------------------------END--JacRed-------------------------------------------------------------------------     
    // Р¤СѓРЅРєС†РёРё СЂР°Р±РѕС‚С‹ СЃ РєР°С‡РµСЃС‚РІРѕРј
    // РЈРґР°Р»СЏРµРј РєР°С‡РµСЃС‚РІРѕ СЃ РєР°СЂС‚РѕС‡РєРё РµСЃР»Рё РµСЃС‚СЊ
    function clearQualityElements(localCurrentCard, render) {
        if (render) $('.full-start__status.maxsm-quality', render).remove();
    }
    // РџР»РµР№СЃС…РѕР»РґРµСЂ РєР°С‡РµСЃС‚РІР°
    function showQualityPlaceholder(localCurrentCard, render) {
        ...
        // РџСЂРѕРІРµСЂСЏРµРј, РЅРµ РґРѕР±Р°РІР»РµРЅ Р»Рё СѓР¶Рµ РїР»РµР№СЃС…РѕР»РґРµСЂ
    ...
    // РџРѕР»СѓС‡Р°РµРј РєР°СЃРµСЃС‚РІРѕ
    ...
    // РћР±РЅРѕРІР»СЏРµРј РєР°С‡РµСЃС‚РІРѕ РІ РєР°СЂС‚РѕС‡РєРµ
    ...
    function fetchAdditionalRatings(card, render) {
        ...
        // РћРїС‚РёРјРёС‰РёСЂСѓРµРј Р»Рё Р·Р°РїСЂРѕСЃС‹ 1 - СЌРєРѕРЅРѕРјРёСЏ, 0 - С‚РѕС‡РЅРѕСЃС‚СЊ (РЅРµ РёР·Р±РµРіР°РµРј Р·Р°РїСЂРѕСЃРѕРІ РєСЃР»Рё РЅР° РєР°СЂС‚РѕС‡РєРµ РµСЃС‚СЊ IMDb Рё KP)
        // var optimize = parseInt(localStorage.getItem('maxsm_ratings_optimize'));

        // РЎС‚Р°С‚СѓСЃС‹ СЂРµР№С‚РёРЅРіРѕРІ
        var kpElement = $('.rate--kp:not(.hide)', render);
        var imdbElement = $('.rate--imdb:not(.hide)', render);
        
        // РџСЂРѕРІРµСЂСЏРµРј, С‡С‚Рѕ РѕР±Р° СЂРµР№С‚РёРЅРіР° СѓР¶Рµ РµСЃС‚СЊ Рё СЃРѕРґРµСЂР¶Р°С‚ С‡РёСЃР»РѕРІС‹Рµ Р·РЅР°С‡РµРЅРёСЏ
        ...
        var imdbExists = imdbElement.length > 0 && !!imdbElement.find('> div').eq(0).text().trim();
            // РђСЃРёРЅС…СЂРѕРЅРЅРѕ РёС‰РµРј РєР°С‡РµСЃС‚РІРѕ 
            if (localStorage.getItem('maxsm_ratings_quality') === 'true' && !(localStorage.getItem('maxsm_ratings_quality_tv') === 'false' && normalizedCard.type === 'tv')) {
                ...
                // 1. РћР±СЂР°Р±Р°С‚С‹РІР°РµРј РєРµС€ РєР°С‡РµСЃС‚РІР°
                if (cacheQualityData) {
        ...
        // 1. РћР±СЂР°Р±Р°С‚С‹РІР°РµРј РєРµС€ РљРёРЅРѕРїРѕРёСЃРєР°
        if (cachedKpData) {
            ...
            getKPRatings(normalizedCard, getRandomToken(KP_API_KEYS), localCurrentCard, function(kpRatings) {
                if (kpRatings) {
                    ...
                    if (kpRatings.imdb) {
                        ratingsData.imdb_kp = kpRatings.imdb; // РµСЃР»Рё С…РѕС‡РµС€СЊ СЃРѕС…СЂР°РЅРёС‚СЊ РѕС‚РґРµР»СЊРЅРѕ, РёР»Рё СЃСЂР°РІРЅРёС‚СЊ
                    }
                    saveKpCache(cacheKey, { kp: kpRatings.kinopoisk, imdb: kpRatings.imdb }, localCurrentCard);
                }
                processNextStep();
            });
            return; // Р’С‹С…РѕРґРёРј, РїСЂРѕРґРѕР»Р¶РёРј РІ РєРѕР»Р±СЌРєРµ
        }
        
        function processNextStep() {

            updateHiddenElements(ratingsData, localCurrentCard, render);
            // 2. РћР±СЂР°Р±Р°С‚С‹РІР°РµРј РєРµС€ OMDB
            if (cachedData) {
        ...
        function updateUI() {
            // Р’СЃС‚Р°РІР»СЏРµРј СЂРµР№С‚РёРЅРіРё RT Рё MC
            ...
            // РћР±РЅРѕРІР»СЏРµРј СЃРєСЂС‹С‚С‹Рµ СЌР»РµРјРµРЅС‚С‹
            updateHiddenElements(ratingsData, localCurrentCard, render);
            ...
            // РЎС‡РёС‚Р°РµРј Рё РѕС‚РѕР±СЂР°Р¶Р°РµРј СЃСЂРµРґРЅРёР№ СЂРµР№С‚РёРЅРі
            if (mode !== 2)
                calculateAverageRating(localCurrentCard, render);
            
            //РњРµРЅСЏРµРј Р»РµР№Р±Р»С‹ РЅР° РёРєРѕРЅРєРё РµСЃР»Рё РЅР°РґРѕ
            var showIcons = localStorage.getItem('maxsm_ratings_icons')  === 'true';
            if (showIcons) insertIcons(localCurrentCard, render);
            
            // РЈР±РёСЂР°РµРј Р°РЅРёРјР°С†РёСЋ Рё РІРѕР·РІСЂР°С‰Р°РµРј СЃС‚СЂРѕРєСѓ СЂРµР№С‚РёРЅРіРѕРІ     
            removeLoadingAnimation(localCurrentCard, render);
            rateLine.css('visibility', 'visible');
            
            // Р”РѕР±Р°РІР»СЏРµРј РѕР±СЂР°Р±РѕС‚С‡РёРє РґР»СЏ РїРѕСЂС‚СЂРµС‚РЅРѕРіРѕ СЂРµР¶РёРјР°
            if (isPortrait) {
...
//-------------------------------------------MODALKA---------------------------------------------------------
    function showRatingsModal(cardId, render) {
        // РџСЂРѕРІРµСЂСЏРµРј РЅР°СЃС‚СЂРѕР№РєСѓ С†РІРµС‚РѕРІ
        var showColors = localStorage.getItem('maxsm_ratings_colors') === 'true';
        
        // РЎРѕР·РґР°РµРј РєРѕРЅС‚РµР№РЅРµСЂ РґР»СЏ РјРѕРґР°Р»СЊРЅРѕРіРѕ РѕРєРЅР°
        var modalContent = $('<div class="maxsm-modal-ratings"></div>');
        
        // РќР°С…РѕРґРёРј СЃС‚СЂРѕРєСѓ СЂРµР№С‚РёРЅРіРѕРІ
        var rateLine = $('.full-start-new__rate-line', render);
        if (!rateLine.length) return;
        
        // РџРѕСЂСЏРґРѕРє РѕС‚РѕР±СЂР°Р¶РµРЅРёСЏ СЂРµР№С‚РёРЅРіРѕРІ
        var ratingOrder = [
            'rate--avg',
            'rate--oscars',
            'rate--emmy',
        ...
        // РЎРѕР±РёСЂР°РµРј СЂРµР№С‚РёРЅРіРё РІ РЅСѓР¶РЅРѕРј РїРѕСЂСЏРґРєРµ
        ratingOrder.forEach(function(className) {
            var element = $('.' + className, rateLine);
            if (element.length) {
                // Р‘РµСЂРµРј Р·РЅР°С‡РµРЅРёРµ РёР· РїРµСЂРІРѕРіРѕ РґРѕС‡РµСЂРЅРµРіРѕ СЌР»РµРјРµРЅС‚Р°
                var value = element.children().eq(0).text().trim();
                var numericValue = parseFloat(value);
                
                // РћРїСЂРµРґРµР»СЏРµРј РЅР°Р·РІР°РЅРёРµ СЂРµР№С‚РёРЅРіР°
                var label = '';
                switch(className) {
                    case 'rate--avg': 
                ...
                // РЎРѕР·РґР°РµРј СЌР»РµРјРµРЅС‚ СЃС‚СЂРѕРєРё СЃ РїСЂРµС„РёРєСЃРЅС‹РјРё РєР»Р°СЃСЃР°РјРё
                var item = $('<div class="maxsm-modal-rating-line"></div>');
                // РџСЂРёРјРµРЅСЏРµРј С†РІРµС‚РѕРІС‹Рµ РєР»Р°СЃСЃС‹ РµСЃР»Рё РІРєР»СЋС‡РµРЅР° РЅР°СЃС‚СЂРѕР№РєР°
                if (showColors) {                
                var colorClass;
                    // Р”Р»СЏ СЃСЂРµРґРЅРµРіРѕ СЂРµР№С‚РёРЅРіР° РёСЃРїРѕР»СЊР·СѓРµРј СЃРїРµС†РёР°Р»СЊРЅСѓСЋ С„СѓРЅРєС†РёСЋ
                    ...
                    // Р”Р»СЏ РѕСЃС‚Р°Р»СЊРЅС‹С… СЂРµР№С‚РёРЅРіРѕРІ РёСЃРїРѕР»СЊР·СѓРµРј РїСЂРµС„РёРєСЃРЅС‹Рµ РєР»Р°СЃСЃС‹
                    else {
        ...
        // РЎРѕР·РґР°РµРј РјРѕРґР°Р»СЊРЅРѕРµ РѕРєРЅРѕ
        Lampa.Modal.open({
...
//------------------------------------------------------------------------------------------------------------------------
    //РњРµРЅСЏРµРј Р»РµР№Р±Р»С‹ РЅР° РёРєРѕРЅРєРё
        ...
        function replaceIcon(className, svg) {
            ...
            if (Element.length) {
                ...
                if (sourceNameElement.length) {
                    ...
                    // Р•СЃР»Рё РЅРµ РЅР°С€Р»Рё .source--name, РїСЂРѕР±СѓРµРј РЅР°Р№С‚Рё РІС‚РѕСЂРѕР№ РґРѕС‡РµСЂРЅРёР№ div
    ...
    // Р¤СѓРЅРєС†РёРё СЂР°Р±РѕС‚С‹ СЃ РєРµС€РµРј
    ...
    function saveOmdbCache(key, data, localCurrentCard) {
        // РџСЂРѕРІРµСЂСЏРµРј РІР°Р»РёРґРЅС‹Рµ СЂРµР№С‚РёРЅРіРё
        var hasValidRating = (
            (data.rt && data.rt !== "N/A") ||
            (data.mc && data.mc !== "N/A") ||
        ...
        // РџСЂРѕРІРµСЂСЏРµРј РІР°Р»РёРґРЅС‹Р№ РІРѕР·СЂР°СЃС‚РЅРѕР№ СЂРµР№С‚РёРЅРі
        ...
        // РўР°РєР¶Рµ СЃС‡РёС‚Р°РµРј РЅР°Р»РёС‡РёРµ РћСЃРєР°СЂРѕРІ РїРѕРІРѕРґРѕРј РєРµС€РёСЂРѕРІР°С‚СЊ
    ...
    // Р¤СѓРЅРєС†РёРё РґР»СЏ СЂР°Р±РѕС‚С‹ СЃ РєРµС€РµРј РљРёРЅРѕРїРѕРёСЃРєР°
    ...
    function saveKpCache(key, data, localCurrentCard) {
        // РћРїС‚РёРјРёС‰РёСЂСѓРµРј Р»Рё Р·Р°РїСЂРѕСЃС‹ 1 - СЌРєРѕРЅРѕРјРёСЏ, 0 - С‚РѕС‡РЅРѕСЃС‚СЊ (РЎРѕС…СЂР°РЅСЏРµРј РІ РєРµС€ РЅР° N  РґРЅРµР№ Рё РїСѓСЃС‚С‹Рµ СЂРµР·СѓР»СЊС‚Р°С‚С‹)
        //var optimize = parseInt(localStorage.getItem('maxsm_ratings_optimize'));
    ...
    // РџРѕР»СѓС‡Р°РµРј IMDB id РёР· TMDB id РїРѕ API
    function getImdbIdFromTmdb(tmdbId, type, localCurrentCard, callback) {
        ...
        // Р¤РѕСЂРјРёСЂСѓРµРј РѕСЃРЅРѕРІРЅРѕР№ URL СЃ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёРµРј Lampa.TMDB.api()
        ...
        // РСЃРїРѕР»СЊР·СѓРµРј С‚РѕР»СЊРєРѕ silent Р·Р°РїСЂРѕСЃ
        new Lampa.Reguest().silent(mainUrl, function(data) {
            if (data && data.imdb_id) {
                ...
                if (cleanType === 'tv') {
                    ...
                    // Р¤РѕСЂРјРёСЂСѓРµРј Р°Р»СЊС‚РµСЂРЅР°С‚РёРІРЅС‹Р№ URL РґР»СЏ TV
    ...
    // РњРѕРґРёС„РёС†РёСЂСѓРµРј fetchOmdbRatings РґР»СЏ РїРѕРґРґРµСЂР¶РєРё callback
    ...
    function updateHiddenElements(ratings, localCurrentCard, render) {
        ...
        // РћР±РЅРѕРІР»РµРЅРёРµ РІРѕР·СЂР°СЃС‚РЅРѕРіРѕ СЂРµР№С‚РёРЅРіР° СЃ РїСЂРѕРІРµСЂРєРѕР№ "Not Rated"
        ...
        // Р—Р°РїРѕР»РЅСЏРµРј IMDb СЂРµР№С‚РёРЅРіР°
        ...
        for (var i = 0; i < ratings.length; i++) {
            if (ratings[i].Source === source) {
                try {
                    ...
                    console.warn('РћС€РёР±РєР° РїСЂРё РїР°СЂСЃРёРЅРіРµ СЂРµР№С‚РёРЅРіР°:', e);
                    return null;
                }
            }
        }
    ...
    function insertRatings(rtRating, mcRating, oscars, awards, emmy, localCurrentCard, render) {
        ...
        if (showAwards && awards && !isNaN(awards) && awards > 0 && !$('.rate--awards', rateLine).length) {
            ...
            rateLine.prepend(awardsElement); // РџСЂРѕСЃС‚Рѕ РІСЃС‚Р°РІР»СЏРµРј РІ РЅР°С‡Р°Р»Рѕ
        }
        ...
        if (showOscar && oscars && !isNaN(oscars) && oscars > 0 && !$('.rate--oscars', rateLine).length) {
            ...
            rateLine.prepend(oscarsElement); // РџСЂРѕСЃС‚Рѕ РІСЃС‚Р°РІР»СЏРµРј РІ РЅР°С‡Р°Р»Рѕ
        }
        ...
        if (showEmmy && emmy && !isNaN(emmy) && emmy > 0 && !$('.rate--emmy', rateLine).length) {
            ...
            rateLine.prepend(emmyElement); // РџСЂРѕСЃС‚Рѕ РІСЃС‚Р°РІР»СЏРµРј РІ РЅР°С‡Р°Р»Рѕ
        }
    }
...
//------------------------------------------------- Р›РµРїРёРј РЅР° РєР°СЂС‚РѕС‡РєРё СЏСЂР»С‹РєРё РєР°С‡РµСЃС‚РІР° (С‡РµСЂРµР· РїРѕР»СѓС‡РµРЅРёРµ СЃ JacRed)
    ...
    // РћР±С‰Р°СЏ С„СѓРЅРєС†РёСЏ РґР»СЏ РїСЂРёРјРµРЅРµРЅРёСЏ РєР°С‡РµСЃС‚РІР° Рє РєР°СЂС‚РѕС‡РєРµ
    ...
    // РћР±СЃРµСЂРІРµСЂ DOM РґР»СЏ РЅРѕРІС‹С… РєР°СЂС‚
    ...
    function startPlugin() {
        ...
        // РЎРѕР·РґР°РЅРёРµ РѕР±СЉРµРєС‚Р° РґР»СЏ Р·РЅР°С‡РµРЅРёР№ РІС‹Р±РѕСЂР° СЂРµР¶РёРјР°
        var modeValue = {};
        ...
        if (localStorage.getItem('maxsm_ratings_quality_inlist') === 'true') {
            // Р’С‹Р·РѕРІ РЅР°Р±Р»СЋРґР°С‚РµР»СЏ
            observer.observe(document.body, { childList: true, subtree: true });
            console.log('MAXSM-RATINGS: observer Start');
        }
        
        // РџРѕРїР°РґР°РЅРёСЏ РІРЅСѓС‚СЂРё РєР°СЂС‚РѕС‡РєРё
