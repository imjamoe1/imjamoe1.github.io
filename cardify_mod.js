(function () {
                        ...
                        this.html.find(".cardify-trailer__youtube-iframe")[0],
                        {
                            ...
                            events: {
                                onReady: function onReady(event) {
                                    ...
                                    if (blurVal > 0) {
                                        $(_this.youtube.getIframe()).css('filter', 'blur(' + blurVal + 'px)');
                                    }
	...
	function startPlugin() {
		...
		var style =
            ...
            ".cardify-trailer__youtube.zoom iframe { transform: scale(1.33) !important; }\n" +
        ...
        Lampa.SettingsApi.addParam({
			...
			field: {
				name: "Розтягування трейлеру",
                description: "Зум 33% (Прибирає чорні полоси відео)"
			}
		});
