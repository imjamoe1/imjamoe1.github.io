...
(function () {
	...
	var Protocol = function Protocol() {
     ...
     var TRASH_R = ['$$$####!!!!!!!', '^^^^^^##@', '@!^^!@#@@$$$$$', '^^#@@!!@#!$', '@#!@@@##$$@@'];
     var version_modss = '3.1', API = Protocol() + 'api.lampa.stream/', type = '', jackets = {}, cards, ping_auth, manifest, menu_list = [], vip = true, leftVipD = '999', user_id = '', uid = '4941c869e985f11cc37f636', IP, logged = undefined, cashe = encodeURIComponent(Lampa.Base64.encode(window.location.origin));
