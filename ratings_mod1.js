...
(function () {
    ...
    function startPlugin() {
        ...
        if (!$('style[data-id="' + style_id + '"]').length) {
            ...
            .new-interface .full-start-new__rate-line {
...
// ------------------------------------------------------------END--JacRed-------------------------------------------------------------------------     
    ...
    function checkAndFixRatingsVisibility(render) {
        var rateLine = $('.full-start-new__rate-line', render);
        if (rateLine.length && rateLine.css('visibility') === 'hidden') {
           rateLine.css('visibility', 'visible');
        }
    
        // Добавьте эту проверку в конце функции fetchAdditionalRatings
        setTimeout(function() {
            checkAndFixRatingsVisibility(render);
        }, 500);
    }
